...
if (isset($_POST['tambahbarang'])) {
    ...
    $addtotable=mysqli_query($conn, "insert into stock (namabarang, deskripsi, stok, harga) values('$namabarang','$deskripsi','$stok', '$harga')");
    if ($addtotable) {
...
if (isset($_POST['barangmasuk'])) {
    ...
    $totalsetelahdistok=$stoksekarang+$qty;

    $addtomasuk=mysqli_query($conn, "insert into masuk (idbarang, keterangan, qty) values('$pilihbaranngnya','$penerima','$qty')");
    $updatestokmasuk=mysqli_query($conn, "update stock set stok='$totalsetelahdistok' where idbarang='$pilihbaranngnya'");
...
if (isset($_POST['barangkeluar'])) {
    ...
    $updatestokkeluar=mysqli_query($conn, "update stock set stok='$totalsetelahdikurang' where idbarang='$pilihbaranngnya'");
